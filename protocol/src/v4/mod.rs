...
impl fmt::Display for Message {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        writeln!(
            f,
            "______________________________HEADER_______________________________________"
        )?;
        writeln!(
            f,
            "operation_code                   | {}",
